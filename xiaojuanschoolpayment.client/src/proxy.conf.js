...
const PROXY_CONFIG = [
  {
    context: ["/weatherforecast", "/auth", "/school", "/school-content", "/internal-commission-policies", "/staff-permissions", "/student-applications", "/Account", "/currency", "/contact-form", "/quote-email", "/pines-room-availability", "/uploads"],
    target,
    secure: false,
    logLevel: "debug",
  },
