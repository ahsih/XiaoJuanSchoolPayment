...
export class BaguioStudyComponent {
  ...
  readonly schoolProfiles: SchoolProfile[] = [
    ...
    },
    {
      ...
      style: 'BECI成人弹性校区，Workcation / Non-Sparta / Coworking / Lite ESL / Speed ESL / BizSpeak / IELTS',
      route: '/philippines-study/baguio/api-beci-city-campus',
      startingPrice: 'USD 1,270 / 4周起（Light ESL + Studio Quad）',
      courses: [
        'Light ESL',
        'Speed ESL',
        'Native ESL',
