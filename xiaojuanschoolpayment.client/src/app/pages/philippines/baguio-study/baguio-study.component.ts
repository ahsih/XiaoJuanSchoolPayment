...
export class BaguioStudyComponent {
  ...
  readonly schoolProfiles: SchoolProfile[] = [
    ...
    },
    {
      ...
      accommodation: '官网强调宿舍舒适度与性价比，适合长期住宿型学习。',
      facilities: '宿舍、学习空间、休闲设施和活动配套较完整，也可关注高尔夫等附加项目。',
      bestFor: '计划 8 周以上长期学习、重视生活稳定度和课程连续性的成人学生。',
      consultantNote: '如果学生担心高压管理过重，MONOL 可作为“稳态学习型”候选；仍需核对当期房型。',
    },
    {
      name: 'WALES Academy',
      location: '碧瑶市中心附近',
      ...
      accommodation: '官网列出 Studio、Premium Studio、Share、Condo 等房型方向。',
      facilities: '教室、商务中心与休息区、餐厅、学生休息区和市区生活便利是主要特点。',
      bestFor: '想要小班容量、成人学习氛围、市区便利和相对灵活节奏的人群。',
      consultantNote: 'WALES 适合不想进入过强斯巴达节奏的学生；亲子或成人商务需求可优先核对。',
    },
    {
      name: 'TALK Academy',
      location: '碧瑶市',
      ...
      accommodation: '以学校安排宿舍为主，需确认校区、房型和当前开放情况。',
      facilities: '课程、自习和住宿集中管理，适合看重考试路径和学习纪律的人。',
      bestFor: '多益目标明确、想短期集中提升听读分数或求职英语能力的学生。',
      consultantNote: 'TALK 信息更新需以学校当期回复为准；建议和 PINES、JIC、WALES 一起比较。',
    },
  ];
