...
export class BacolodStudyComponent {
  ...
  readonly page = createCityStudyPage({
    ...
    heroLessonImage: '/assets/philippines/monol-classroom-group.webp',
    ...
    selectionImages: [
      '/assets/philippines/monol-classroom.webp',
      '/assets/philippines/wales-school-building.webp',
      '/assets/philippines/pines-library.webp',
      '/assets/philippines/cebu-city-view.webp',
    ],
    lifestyleImages: [
      '/assets/philippines/monol-food-service.webp',
      '/assets/philippines/monol-rooftop-lounge.webp',
