...
export const mainNavigation: NavigationItem[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: '理工大学/理工学院',
            route: '/ireland-study/schools/technology-universities',
          },
          {
            id: 'ireland-private-schools',
            label: '私立院校',
            route: '/ireland-study/schools/private-colleges',
          },
          {
          ...
          { id: 'nci', label: 'NCI 爱尔兰国家学院', route: '/ireland-study/schools/nci' },
          {
            ...
            route: '/ireland-study/schools/schm',
          },
          {
            id: 'mic',
            label: 'MIC 爱尔兰伊玛克特教育学院',
            route: '/ireland-study/schools/mic',
          },
        ],
      },
      {
      ...
      },
      {
        id: 'ireland-master',
        label: '爱尔兰硕士申请',
        route: '/ireland-study/master-application',
        type: '服务页',
      },
      {
        id: 'ireland-foundation',
        label: '爱尔兰预科申请',
        route: '/ireland-study/foundation-application',
        type: '服务页',
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: '研究生课程申请',
            route: '/ireland-study/application/postgraduate-course',
          },
        ],
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: '住宿指南',
            route: '/ireland-study/accommodation-guide',
          },
        ],
      },
      {
        ...
        children: [
          ...
          },
          {
            id: 'ireland-banking',
            label: '货币和银行服务',
            route: '/ireland-study/banking',
          },
          {
            id: 'ireland-health-safety',
            label: '健康与安全',
            route: '/ireland-study/health-safety',
          },
          {
            id: 'ireland-pre-departure',
            label: '行前准备清单',
            route: '/ireland-study/pre-departure',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '菲律宾外教一对一',
        route: '/online-english/filipino-teacher-1v1',
        type: '课程页',
      },
      {
        id: 'ielts-speaking-writing',
        label: '雅思口语/写作辅导',
        route: '/online-english/ielts-speaking-writing',
        type: '课程页',
      },
      {
        id: 'junior-online-english',
        label: '青少年英语课程',
        route: '/online-english/junior-courses',
        type: '课程页',
      },
      {
        id: 'adult-speaking',
        label: '成人口语课程',
        route: '/online-english/adult-speaking',
        type: '课程页',
      },
      {
        id: 'trial-booking',
        label: '体验课预约',
        route: '/online-english/trial-booking',
        type: '转化页',
      },
      {
        id: 'online-english-faq',
        label: '线上英语常见问题',
        route: '/online-english/faq',
        type: 'FAQ页',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 'usa-tour',
        label: '美国游学',
        route: '/overseas-study-tour/usa',
        type: '国家页',
      },
      {
        id: 'france-tour',
        label: '法国游学',
        route: '/overseas-study-tour/france',
        type: '国家页',
      },
      {
        id: 'germany-tour',
        label: '德国游学',
        route: '/overseas-study-tour/germany',
        type: '国家页',
      },
      {
        id: 'vietnam-tour',
        label: '越南游学',
        route: '/overseas-study-tour/vietnam',
        type: '国家页',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '如何选择语言学校',
        route: '/study-tour-guide/choose-language-school',
        type: 'SEO指南页',
      },
      {
        id: 'philippines-guide',
        label: '菲律宾游学指南',
        route: '/study-tour-guide/philippines',
        type: 'SEO指南页',
      },
      {
        id: 'online-english-guide',
        label: '线上英语怎么选',
        route: '/study-tour-guide/online-english',
        type: 'SEO指南页',
      },
      {
        id: 'family-tour-guide',
        label: '亲子游学指南',
        route: '/study-tour-guide/family',
        type: 'SEO指南页',
      },
      {
        id: 'holiday-tour-guide',
        label: '寒暑假游学指南',
        route: '/study-tour-guide/holiday',
        type: 'SEO指南页',
      },
      {
        id: 'ielts-tour-guide',
        label: '雅思备考游学指南',
        route: '/study-tour-guide/ielts',
        type: 'SEO指南页',
      },
      {
        id: 'gap-year-guide',
        label: 'Gap Year 游学指南',
        route: '/study-tour-guide/gap-year',
        type: 'SEO指南页',
      },
      {
        id: 'tour-accommodation-guide',
        label: '游学住宿指南',
        route: '/study-tour-guide/accommodation',
        type: 'SEO指南页',
      },
      {
        id: 'tour-visa-guide',
        label: '游学签证指南',
        route: '/study-tour-guide/visa',
        type: 'SEO指南页',
      },
      {
        id: 'tour-pre-departure',
        label: '行前准备清单',
        route: '/study-tour-guide/pre-departure',
        type: '工具页',
      },
      {
        id: 'tour-faq',
        label: '游学常见问题',
        route: '/study-tour-guide/faq',
        type: 'FAQ页',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '爱尔兰申请时间线',
        route: '/study-abroad-guide/ireland-application-timeline',
        type: 'SEO指南页',
      },
      {
        id: 'ireland-school-selection',
        label: '爱尔兰院校选择指南',
        route: '/study-abroad-guide/ireland-school-selection',
        type: 'SEO指南页',
      },
      {
        id: 'ireland-work-study-guide',
        label: '爱尔兰半工半读指南',
        route: '/study-abroad-guide/ireland-work-study',
        type: 'SEO指南页',
      },
      {
        id: 'undergraduate-guide',
        label: '本科申请指南',
        route: '/study-abroad-guide/undergraduate',
        type: 'SEO指南页',
      },
      {
        id: 'master-guide',
        label: '硕士申请指南',
        route: '/study-abroad-guide/master',
        type: 'SEO指南页',
      },
      {
        id: 'foundation-guide',
        label: '预科申请指南',
        route: '/study-abroad-guide/foundation',
        type: 'SEO指南页',
      },
      {
        id: 'major-selection-guide',
        label: '专业选择指南',
        route: '/study-abroad-guide/major-selection',
        type: 'SEO指南页',
      },
      {
        id: 'application-materials',
        label: '申请材料清单',
        route: '/study-abroad-guide/application-materials',
        type: '工具页',
      },
      {
        id: 'study-visa-guide',
        label: '签证申请指南',
        route: '/study-abroad-guide/visa',
        type: 'SEO指南页',
      },
      {
        id: 'study-pre-departure',
        label: '住宿与行前准备',
        route: '/study-abroad-guide/pre-departure',
        type: 'SEO指南页',
      },
      {
        id: 'study-faq',
        label: '留学常见问题',
        route: '/study-abroad-guide/faq',
        type: 'FAQ页',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 'liuxue-feedback',
        label: '留学反馈',
        route: '/student-feedback/study-abroad',
        type: '反馈页',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 'services',
        label: '服务项目',
        route: '/about-sida/services',
        type: '品牌页',
      },
      {
        id: 'advantages',
        label: '服务优势',
        route: '/about-sida/advantages',
        type: '品牌页',
      },
      {
        id: 'consultants',
        label: '顾问团队',
        route: '/about-sida/consultants',
        type: '团队页',
      },
      {
        id: 'pricing',
        label: '收费说明',
        route: '/about-sida/pricing',
        type: '说明页',
      },
      {
        id: 'contact',
        label: '联系我们',
        route: '/about-sida/contact',
        type: '联系页',
      },
    ],
  },
