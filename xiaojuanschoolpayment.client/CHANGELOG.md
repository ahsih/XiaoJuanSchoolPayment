...
- Create Angular project with ng: `ng new xiaojuanschoolpayment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`xiaojuanschoolpayment.client.esproj`).
